    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          // Please change this to your repo.
          editUrl:
            'https://github.com/baizhiheizi/docs.ohmy.xin/tree/main',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'OhMy Circle',
                href: 'https://ohmy.xin/circles/997103',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} OhMy.xin. Built with Docusaurus.`,
      },
      prism: {
